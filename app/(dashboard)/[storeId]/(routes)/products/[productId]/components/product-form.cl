                            ...
                            <FormItem>
                                ...
                                <FormControl>
                                    <ImageUpload
                                        ...
                                        disabled={loading}
                                        onChange={(newUrl) => {
                                            // This is causing the nesting issue - let's fix it
                                            // Current: field.onChange([...field.value, { url }])
                                            // The url here is already the full URL string, no need to wrap in object
                                            field.onChange([
                                                ...field.value, // Keep existing images
                                                { url: newUrl } // Properly format the new image object
                                            ])
                                        }}
                                        onRemove={(url) => {
                                            field.onChange(
